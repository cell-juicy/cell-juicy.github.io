...
##### 9.4.3 证明命题9.4.10<span style="color:blue">（提示：你可以把[引理6.5.3](/docs/Real-Analysis/Chap6/Sec5.md)，[夹逼定理（推论6.4.14）](/docs/Real-Analysis/Chap6/Sec4.md)以及[命题6.7.3](/docs/Real-Analysis/Chap6/Sec7.md)结合起来使用）</span>
...
##### 9.4.4 证明命题9.4.11<span style="color:blue">（提示：利用极限定律（[命题9.3.14](/docs/Real-Analysis/Chap9/Sec3.md)）可以证明$\displaystyle\lim_{x\to 1}x^n=1$对所有的整数$n$都成立。利用这个命题和[夹逼定理](/docs/Real-Analysis/Chap6/Sec4.md)推导出$\displaystyle\lim_{x\to 1}x^p=1$对所有的实数$p$都成立。最后，使用[命题6.7.3](/docs/Real-Analysis/Chap6/Sec7.md)）</span>
