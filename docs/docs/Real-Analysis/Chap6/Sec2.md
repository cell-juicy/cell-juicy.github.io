...
<span style="color:blue">（顺便贴下[定义5.5.10](/docs/Real-Analysis/Chap5/Sec5.md)防查看麻烦）：</span>

> 设$E$是实数集的一个子集，如果$E$是非空的并且存在一个上界，则定义$\sup(E)$为$E$的最小上界<span style="color:blue">（由[定理5.5.9](/docs/Real-Analysis/Chap5/Sec5.md)可知，该定义是明确的）</span>。额外引入两个符号$+\infty$与$-\infty$。如果$E$是非空的并且没有上界，则令$\sup(E):=+\infty$；如果$E$是空集，则定义$\sup(E):=-\infty$，称$\sup(E)$是$E$的**上确界**，也可以记作$\sup E$。
...
##### 6.2.1 证明命题6.2.5<span style="color:blue">（提示：你可能会用到[命题5.4.7](/docs/Real-Analysis/Chap5/Sec4.md)）</span>
...
##### 6.2.2 证明定理6.2.11<span style="color:blue">（提示：你可能要用到根据$+\infty$和$-\infty$是否属于$E$来分情况考虑。如果$E$中只包含实数，那么你当然可以利用[定义5.5.10](/docs/Real-Analysis/Chap5/Sec5.md)）</span>
