...
##### 15.1.1 证明定理15.1.6<span style="color:blue">（提示：对(a)和(b)使用根值判别法（[定理7.5.1](/docs/Real-Analysis/Chap7/Sec5.md)）；对(c)使用魏尔斯特拉斯M判别法（[定理14.5.7](/docs/Real-Analysis/Chap14/Sec5.md)）；对(d)使用[定理14.7.1](/docs/Real-Analysis/Chap14/Sec7.md)；对(e)使用[推论14.6.2](/docs/Real-Analysis/Chap14/Sec6.md)）</span>
