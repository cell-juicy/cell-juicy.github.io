...
##### 13.5.3 设$(X,d)$是一个度量空间（从而自然也是一个拓扑空间）。证明：[定义12.2.5](/docs/Real-Analysis/Chap12/Sec2.md)和定义13.5.5中的内点、外点和边界点的概念是一致的
...
##### 13.5.14 把[定理12.5.10](/docs/Real-Analysis/Chap12/Sec5.md)推广到豪斯道夫空间中的紧致集合上
...
##### 13.5.15 设$(X,d_X)$和$(Y,d_Y)$是两个度量空间<span style="color:blue">（从而也是拓扑空间）</span>。证明：[定义13.1.1](/docs/Real-Analysis/Chap13/Sec1.md)和定义13.5.8中函数$f:X\to Y$的连续性概念<span style="color:blue">（在一点处的连续概念以及在整个定义域上的连续概念）</span>是一致的
...
##### 13.5.16 证明：如果把[定理13.1.4](/docs/Real-Analysis/Chap13/Sec1.md)推广到拓扑空间，那么(a)就蕴含了(b)<span style="color:blue">（逆命题不成立，但构造一个反例并不容易）</span>；证明：如果把[定理13.1.5](/docs/Real-Analysis/Chap13/Sec1.md)推广到拓扑空间，那么(a)、(c)、(d)三者是等价的，它们都蕴含着(b)<span style="color:blue">（同样，逆向的蕴含关系不成立，但想证明这一点比较困难）</span>
...
##### 13.5.17 把[定理13.3.1](/docs/Real-Analysis/Chap13/Sec3.md)和[命题13.3.2](/docs/Real-Analysis/Chap13/Sec3.md)推广到拓扑空间中的紧致集合上
