...
##### 12.2.2 证明命题12.2.10<span style="color:blue">（提示：对某些蕴含关系的证明需要用到[选择公理](/docs/Real-Analysis/Chap12/Sec2.md)，就像在[引理8.4.5](/docs/Real-Analysis/Chap12/Sec2.md)的证明中那样）</span>
